...
class variableMisuse(base_ff):
    ...
    def __init__(self):
        ...
        print(paths)
        self.model = load_trained_model_from_checkpoint(paths.config, paths.checkpoint, training=True, seq_len=128, out_dim=2)
        print("model loaded")
    ...
    def evaluate(self, ind, **kwargs):
        ...
        guess_nt = InputExample(guid=guid, text_a=ind.phenotype, text_b=None, label="Correct")
